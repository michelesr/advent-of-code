...
# others should all be linked to a XOR so fixing those connections is 3 or 4
# pairs (at least in my input)
#
# Last one was trickier... but it's a binary adder, so you can figure out how
# it works and how it should be connected.
#
...
#     g.edge(gate.in_a.name, gate_s)
#     g.edge(gate.in_b.name, gate_s)
#     g.edge(gate_s, gate.out.name)
# g.view()
